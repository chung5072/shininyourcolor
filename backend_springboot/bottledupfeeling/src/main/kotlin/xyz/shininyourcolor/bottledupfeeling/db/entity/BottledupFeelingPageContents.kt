package xyz.shininyourcolor.bottledupfeeling.db.entity

import jakarta.persistence.*
import java.time.LocalDateTime

@Table(name = "bottledup_feeling_page_contents")
@Entity
data class BottledupFeelingPageContents(
    /**
     * 유저의 안드로이드 id
     */
    ...
    /**
     * bottledup_feeling_page_contents 테이블의 ID
     */
    @Id
    @Column(name = "bfpc_id")
